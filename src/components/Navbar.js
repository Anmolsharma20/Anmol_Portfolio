          ...
          <ul className="navbar-nav ms-lg-4">
            <li className="nav-item dropdown">
              ...
              <ul className="dropdown-menu" aria-labelledby="profilesDropdown">
                ...
                <li><a className="dropdown-item" href="https://drive.google.com/file/d/1RiUZgHtNQYgbQggkhg1T3Tl6FWA19wcv/view?usp=sharing" target="_blank" rel="noopener noreferrer" download="Anmol_Sharma_Resume.pdf">Resume</a></li>
              </ul>
            </li>
          </ul>
        </div>
